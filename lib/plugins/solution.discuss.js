...
function getSolution(problem, lang, cb) {
  ...
  var discuss_num = 1;
  if (lang === 'any') discuss_num = 1;
  else if (lang === 'any2') discuss_num = 2;
  else if (lang === 'any3') discuss_num = 3;
  ...
  var opts = {
    ...
    body: {
      ...
      variables:     JSON.stringify({
        ...
        tags:       (lang === 'any'||'any2'||'any3')? undefined:[lang]
      })
    }
  };
  request(opts, function(e, resp, body) {
    ...
    const solution = solutions.length > (discuss_num-1) ? solutions[discuss_num-1].node : null;
